...
public class Start {
	...
	public static void main(String[] args)
	{
		...
		/*
		 * Resource keystore = Resource.newClassPathResource("/keystore.p12"); if
		 * (keystore != null && keystore.exists()) { // if a keystore for a SSL
		 * certificate is available, start a SSL // connector on port 8443. // By
		 * default, the quickstart comes with a Apache Wicket Quickstart // Certificate
		 * that expires about half way september 2031. Do not // use this certificate
		 ...
		 * https.setPort(8443); https.setIdleTimeout(500000);
		 * 
